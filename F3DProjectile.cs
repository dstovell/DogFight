	...
	public class F3DProjectile : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (isHit)
            {
                ...
                if (!isFXSpawned)
                {
					bool isDamaging = ( this.damageMask == (this.damageMask | (1 << hitPoint.collider.gameObject.layer)) );
					if (isDamaging)
					{
						F3DFXController.instance.OnProjectileHit(this, hitPoint.transform.gameObject, hitPoint.point);
					}
